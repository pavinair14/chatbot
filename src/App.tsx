...
function App() {
  ...
  return (
    <div className="w-md rounded-xl shadow-lg bg-white">
      ...
      <div ref={chatBodyRef} className="p-6 h-[500px] overflow-y-auto scrollbar-thin scrollbar-thumb-slate-300 scrollbar-track-transparent">
